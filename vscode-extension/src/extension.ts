...
export function activate(context: vscode.ExtensionContext) {
	let disposable = vscode.commands.registerCommand('copy-ruby-reference.copy-reference', () => {
		...
		if (selection && filePath) {
			...
			if (reference !== "null") {
				...
				vscode.window.showInformationMessage(`Couldn't find a constant definition!`);
			}
		} else {
